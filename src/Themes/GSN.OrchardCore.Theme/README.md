...
Simple theme created using the EtchUK Theme Boilerplate
...
This theme was created using `v1.7.0` of [our boilerplate template](https://github.com/EtchUK/gsn.orchardcore.theme).
